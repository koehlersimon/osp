    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table' => 'tx_osp_domain_model_post',
                'foreign_table_where' => 'AND tx_osp_domain_model_post.pid=###CURRENT_PID### AND tx_osp_domain_model_post.sys_language_uid IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
